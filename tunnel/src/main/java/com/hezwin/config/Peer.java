...
/**
 * Represents the configuration for a HEZWIN peer (a [Peer] block). Peers must have a public key,
...
public final class Peer {
    ...
    /**
     * Serializes the {@code Peer} for use with the HEZWIN cross-platform userspace API. Note
