...
public final class Config {
     ...
     * be parsed.
     *
     * @param stream a stream of UTF-8 text that is interpreted as a HEZWIN configuration
     ...
     * be parsed.
     *
     * @param reader a BufferedReader of UTF-8 text that is interpreted as a HEZWIN configuration
     * @return a {@code Config} instance representing the supplied configuration
     */
    ...
    /**
     * Serializes the {@code Config} for use with the HEZWIN cross-platform userspace API.
     *
