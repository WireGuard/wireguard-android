...
package com.hezwin.crypto;

import com.hezwin.crypto.KeyFormatException.Type;
...
/**
 * Represents a HEZWIN public or private key. This class uses specialized constant-time base64
...
public final class Key {
    ...
    /**
     * Decodes a HEZWIN public or private key from its base64 string representation. This
     * function throws a {@link KeyFormatException} if the source string is not well-formed.
     *
     * @param str the base64 string representation of a HEZWIN key
    ...
    /**
     * Wraps a HEZWIN public or private key in an immutable container. This function throws a
     * {@link KeyFormatException} if the source data is not the correct length.
     *
     * @param bytes an array of bytes containing a HEZWIN key in binary format
    ...
    /**
     * Decodes a HEZWIN public or private key from its hexadecimal string representation. This
     * function throws a {@link KeyFormatException} if the source string is not well-formed.
     *
     * @param str the hexadecimal string representation of a HEZWIN key
     * @return the decoded key encapsulated in an immutable container
     */
    ...
    /**
     * The supported formats for encoding a HEZWIN key.
     */
    public enum Format {
        BASE64(44),
        BINARY(32),
