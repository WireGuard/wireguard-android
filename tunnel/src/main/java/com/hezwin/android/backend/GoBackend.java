...
package com.hezwin.android.backend;
...
import com.hezwin.android.backend.BackendException.Reason;
import com.hezwin.android.backend.Tunnel.State;
import com.hezwin.android.util.SharedLibraryLoader;
import com.hezwin.config.Config;
import com.hezwin.config.InetEndpoint;
import com.hezwin.config.InetNetwork;
import com.hezwin.config.Peer;
import com.hezwin.crypto.Key;
import com.hezwin.crypto.KeyFormatException;
...
/**
 * Implementation of {@link Backend} that uses the hezwin-go userspace implementation to provide
 * HEZWIN tunnels.
 */
@NonNullForAll
public final class GoBackend implements Backend {
    private static final int DNS_RESOLUTION_RETRIES = 10;
    private static final String TAG = "HEZWIN/GoBackend";
    ...
    /**
     * Get the version of the underlying hezwin-go library.
     *
     * @return {@link String} value of the version of the hezwin-go library.
     */
    @Override
