...
public class Statistics {
     ...
     *
     * @param key               A HEZWIN public key bound to a particular peer
     * @param rxBytes           The received traffic for the {@link com.hezwin.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes
     * @param txBytes           The transmitted traffic for the {@link com.hezwin.config.Peer} referenced by
     *                          the provided {@link Key}. This value is in bytes.
     * @param latestHandshake   The timestamp of the latest handshake for the {@link com.hezwin.config.Peer}
    ...
    /**
     * Get the statistics for the {@link com.hezwin.config.Peer} referenced by the provided {@link Key}
     *
     * @param peer A {@link Key} representing a {@link com.hezwin.config.Peer}.
     ...
     *
     * @return An array of {@link Key} instances representing HEZWIN
     * {@link com.hezwin.config.Peer}s
     */
    public Key[] peers() {
