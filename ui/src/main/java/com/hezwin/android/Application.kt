...
import com.hezwin.android.configStore.FileConfigStore
import com.hezwin.android.model.TunnelManager
import com.hezwin.android.updater.Updater
import com.hezwin.android.util.RootShell
import com.hezwin.android.util.ToolsInstaller
...
class Application : android.app.Application() {
    ...
    companion object {
        val USER_AGENT = String.format(Locale.ENGLISH, "HEZWIN/%s (Android %d; %s; %s; %s %s; %s)", BuildConfig.VERSION_NAME, Build.VERSION.SDK_INT, if (Build.SUPPORTED_ABIS.isNotEmpty()) Build.SUPPORTED_ABIS[0] else "unknown ABI", Build.BOARD, Build.MANUFACTURER, Build.MODEL, Build.FINGERPRINT)
        private const val TAG = "HEZWIN/Application"
