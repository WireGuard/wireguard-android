...
import com.hezwin.android.databinding.LogViewerActivityBinding
import com.hezwin.android.util.DownloadsFileSaver
import com.hezwin.android.util.ErrorMessages
import com.hezwin.android.util.resolveAttribute
...
class LogViewerActivity : AppCompatActivity() {
    ...
    private suspend fun saveLog() {
        ...
        withContext(Dispatchers.IO) {
            try {
                outputFile = downloadsFileSaver.save("hezwin-log.txt", "text/plain", true)
    ...
    companion object {
        ...
        private const val TAG = "HEZWIN/LogViewerActivity"
    }
    ...
    class ExportedLogContentProvider : ContentProvider() {
        ...
        override fun query(uri: Uri, projection: Array<out String>?, selection: String?, selectionArgs: Array<out String>?, sortOrder: String?): Cursor? =
            logForUri(uri)?.let {
                ...
                m.addRow(arrayOf<Any>("hezwin-log.txt", it.size.toLong()))
                m
            }
